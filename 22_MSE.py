...
if __name__ == "__main__":
    ...
    #test_csv_path = '/home/iwata/Downloads/test_10/pa-_test_10/pa-_test.csv'
    #test_csv_path = '/home/iwata/Downloads/test/choki_test/choki_test.csv'
    train_csv_path = '2_19_hand.csv'
    #train_csv_path = '/home/iwata/Downloads/hand_all/2_19_hand.csv'
    #train_csv_path = '/home/iwata/Downloads/hand_all/hand_300.csv'
    #train_csv_path = '/home/iwata/Downloads/hand_all/hand_300.csv'

    #test_csv_path = '/home/iwata/Downloads/test_15/gu_test_15/gu_test.csv'
    #test_csv_path = '/home/iwata/Downloads/test_5/choki_test_5/choki_test.csv'
    #test_csv_path = '/home/iwata/Downloads/test_15/pa-_test_15/pa-_test.csv'

    #test_csv_path = '/home/iwata/Downloads/test_1/gu_test_1/gu_train.csv'
    #test_csv_path = 'test_1/choki_test_1/choki_train.csv'
    #test_csv_path = '/home/iwata/Downloads/test_1/pa-_test_1/pa-_train.csv'
    ...
    # 予測結果のプロット（すべてのテストサンプル）
    for sample_index in range(len(x_test)):
        x_test_batch = torch.tensor(x_test[sample_index:sample_index+batch_size], dtype=torch.float32).unsqueeze(1).to(device)
        y_test_batch = torch.tensor(y_test[sample_index:sample_index+batch_size], dtype=torch.float32).to(device)
        ...
        with torch.no_grad():
            ...
            # プロットの設定
            save_path = f'/home/iwata/Pictures/hand_landmarks_comparison_corrected_{sample_index+1}.png'
